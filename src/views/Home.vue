<template>
       ...
       <div id="page-wraper">
        <div class="wrapper">
            ...
            <section id="intro" class="intro-fullscreen">
                <!--Static Hero-->
                <div class="intro-media bg-image overlay-dark20" data-background-img="img/background.jpg"></div>
                <div class="intro-caption-waper dark-bg">
                    <div class="intro-full-height container">
                        <div class="intro-content">
                            <div class="intro-content-inner">
                                <div class="intro-img-circle">
                                    <img src="img/me.jpg" alt="avatar01" />
                                </div>
                                <h1 class="intro-title mb-10"><span class="text-light">Hi! I am</span> Ashley Zagorski</h1>
                                <h6 class="page-title-alt color mb-45">Software Engineer</h6>
                ...
                <div class="container mb-60">
                    <div class="row text-center">
                        <div class="col-md-6 wow slideInUp" data-wow-delay="0.2s" data-wow-duration="1s">
                            <img src="img/coding.png" style="max-width: 457px; width: 100%;" alt="mockup" />
                        </div>
                        <div class="col-md-6 wow fadeIn" data-wow-delay="0.4s" data-wow-duration="2s">
                            <div class="spacer-15"></div>
                            <h6 class="page-title-alt color mb-10">About Me</h6>
                            <h2 class="page-title mb-25">Software <span class="text-light">Engineer</span></h2>
                            <p class="mb-35">I recently transitioned careers from a speech therapist to a software engineer. My focus has changed from enhancing developing, fixing language in humans to developing, enhancing, and fixing language in computers. I realized how important technology was in today’s society and how much of an impact it could have and quickly became intrigued with being a part of that influence. The skills and knowledge I have gained from being a speech therapist have proven valuable tools in advancing and accelerating my programming abilities. I have developed a passion for studying, teaching, using and influencing communication in computers. I love the creative world program has opened up for me and love creating new things. </p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section id="service" class="section-padding">
                <div class="container mb-60 text-center">
                    <h2>Resume <span class="text-light"></span></h2>
             ...
             <!-- Team Section -->
            <section id="portfolio" class="section-padding white-bg text-center">
                <div class="container">
                    <h2 class="page-title">Portfolio <span class="text-light"></span></h2>
                </div>
                <div class="container">
                    <div class="row">
                        <!--Team Carousel -->
                        <div class="owl-carousel team-carousel nf-carousel-theme">
                            ...
                            <div class="item">
                                <div class="team-item">
                                    <div class="team-item-img">
                                        <img src="img/AlexaCode.png" alt="" />
                                        <div class="team-item-detail">
                                            <div class="team-item-detail-inner light-color">
                                                <h5>Teddy Care</h5>
                                                <p>An interactive health app with an integrated voice design.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="team-item-info">
                                        <h6>Teddycare App</h6>
                                        <p class="">( Healthcare Application )</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="item">
                                <div class="team-item">
                                    <div class="team-item-img">
                                        <img src="img/AlexaCode2.png" alt="" />
                                        <div class="team-item-detail">
                                            <div class="team-item-detail-inner light-color">
                                                <h5>Roaming Roots Tea Co.</h5>
                                                <p>Online loose-leaf tea store.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="team-item-info">
                                        <h6>Roaming Roots Tea Co.</h6>
                                        <p class="">( Online Store )</p>
                                    </div>
                                </div>
                            </div>
            ...
            <section id="video-action" class="section-padding bg-image overlay-dark dark-bg" data-stellar-background-ratio="0.5" data-background-img="img/full/02.jpg">
                <div class="container text-center">
                    <div class="page-icon">
                        <video class="video-popup white" width="320" height="240" controls>
                         <source src="img/IMG_1619.mov" type="video/mp4">
                    ...
                    <p class="max-width-700 lead">
                        See TeddyCare App in Action.
                    </p>
                    <h6 class="page-title-alt color mb-0">Watch Video</h6>
                </div>
            </section>
            <!-- End video Section -->
            ...
            <section id="skills" class="section-padding">
                <div class="container mb-60 text-center">
                    <h2> My <span class="text-light">Skills</span></h2>
                    <p class="max-width-700 large">Here are a few of the things I can do.</p>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-sm-12 pt-30 pt-sm-0">
                            ...
                            <div class="content-box right wow fadeIn" data-wow-delay="0.2s" data-wow-duration="4s">
                                ...
                                <h5 class="features-title">HTML 5</h5>
                                <p></p>
                            </div>
                            <div class="content-box right wow fadeIn" data-wow-delay="0.2s" data-wow-duration="6s">
                                ...
                                <h5 class="features-title">ClEAN CODE AND DESIGN</h5>
                                <p></p>
                            </div>
                            <div class="content-box right wow fadeIn" data-wow-delay="0.2s" data-wow-duration="8s">
                                ...
                                <h5 class="features-title">SINATRA</h5>
                                <p></p>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12 d-lg-block d-sm-none .d-md-none text-center">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 pt-30 pt-sm-0">
                            <div class="content-box left wow fadeIn" data-wow-delay="0.2s" data-wow-duration="2s">
                                ...
                                <h5 class="features-title">RUBY</h5>
                                <p></p>
                            </div>
                            <div class="content-box left wow fadeIn" data-wow-delay="0.4s" data-wow-duration="2s">
                                ...
                                <h5 class="features-title">RAILS</h5>
                                <p></p>
                            </div>
                            <div class="content-box left wow fadeIn" data-wow-delay="0.6s" data-wow-duration="2s">
                                ...
                                <h5 class="features-title">JAVASCRIPT</h5>
                                <p></p>
                            </div>
                            <div class="content-box left wow fadeIn" data-wow-delay="0.8s" data-wow-duration="2s">
                                ...
                                <h5 class="features-title">VUE.JS</h5>
                                <p></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="owl-carousel testimonial-carousel nf-carousel-theme white">
                        <div class="item">
                            <div class="testimonial text-center max-width-700">
                                ...
                                <p class="lead">Step out of the history that is holding you back. Step into the new story you are willing to create.</p>
                                <h6 class="quote-author">Oprah Winfrey <span class="text-regular">( Appel Studio )</span></h6>
                            </div>
                        </div>
                        <div class="item">
                            <div class="testimonial text-center max-width-700">
                                <div class="page-icon-sm"><i class="fa fa-quote-right"></i></div>
                                <p class="lead">Always do what you are afraid to do.</p>
                                <h6 class="quote-author">Ralph Waldo Emerson <span class="text-regular">( USA )</span></h6>
                            </div>
                        </div>
                        <div class="item">
                            <div class="testimonial text-center max-width-700">
  ...
  <section id="interests" class="section-padding">
       <div class="container text-center">
           <h2 class="page-title">Interests<span class="text-light"></span></h2>
       </div>
       <div class="container text-center">
           <div class="row">
               <div class="process-box col-lg-2 col-md-4 col-sm-6 col-12 wow fadeIn" data-wow-delay="0.2s" data-wow-duration="2s">
                   <div class="tipped" data-title="Drink Tea" data-tipper-options='{"direction":"top"}'>
               ...
               <div class="process-box col-lg-2 col-md-4 col-sm-6 col-12 wow fadeIn" data-wow-delay="0.4s" data-wow-duration="2s">
                   <div class="tipped" data-title="Writ and then write some more." data-tipper-options='{"direction":"top"}'>
               ...
               <div class="process-box col-lg-2 col-md-4 col-sm-6 col-12 wow fadeIn" data-wow-delay="0.6s" data-wow-duration="2s">
                   <div class="tipped" data-title="Be one with nature" data-tipper-options='{"direction":"top"}'>
               ...
               <div class="process-box col-lg-2 col-md-4 col-sm-6 col-12 wow fadeIn" data-wow-delay="0.8s" data-wow-duration="2s">
                   <div class="tipped" data-title="Challenge your mind" data-tipper-options='{"direction":"top"}'>
                       <div class="process-icon alt-icon-top"><i class="icon icon-basic-gear"></i></div>
                       <h6>Jigsaw Puzzles</h6>
                   </div>
               </div>
               <div class="process-box col-lg-2 col-md-4 col-sm-6 col-12 wow fadeIn" data-wow-delay="1s" data-wow-duration="2s">
                   <div class="tipped" data-title="Relax your mind" data-tipper-options='{"direction":"top"}'>
               ...
               <div class="process-box col-lg-2 col-md-4 col-sm-6 col-12 wow fadeIn" data-wow-delay="1.2s" data-wow-duration="2s">
                   <div class="tipped" data-title="Be active" data-tipper-options='{"direction":"top"}'>
                ...
                <div class="container text-center">
                    ...
                    <div class="footer-logo mb-25 wow fadeInUp" data-wow-duration="1.5s">
                        <a class="scroll-top" href="#intro">
                            <img src="img/Mark-green.png" alt="ashley" />
                        </a>
                    </div>
                    <!--End Footer Logo-->
                    ...
                    <p class="copyright mb-25">
                        &copy; 2018 <a><b>Ashley Zagorski</b></a>. All Rights Reserved.<br>
                    ...
                    <ul class="social">
                        <li>
                            <a href="https://www.facebook.com/" target="_blank"><i class="fa fa-github"></i></a>
                        </li>
                        <li>
                            <a href="https://www.twitter.com/" target="_blank"><i class="fa fa-twitter"></i></a>
                        </li>
                        <li>
                            <a href="https://www.linkedin.com/ashley-zagorski" target="_blank"><i class="fa fa-linkedin"></i></a>
                        </li>
                        <li>
